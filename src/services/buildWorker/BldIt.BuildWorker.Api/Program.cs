...
builder.Services.AddMongoRepository<WorkerBuildStep, Guid>(nameof(WorkerBuildStep));
...
builder.Services.AddMongoRepository<WorkerJobConfig, Guid>(nameof(WorkerJobConfig));
